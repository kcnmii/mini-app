    ...
    return InvoiceRenderPayload.model_validate(
        {
            ...
            "SUPPLIER_NAME": "ТОО Demo Supplier",
            "SUPPLIER_IIN": "123456789012",
            "SUPPLIER_ADDRESS": "г. Алматы, ул. Абая, 10",
            "COMPANY_NAME": "ТОО Demo Supplier",
            "COMPANY_IIN": "123456789012",
            "COMPANY_IIC": "KZ123456789012345678",
            "COMPANY_BIC": "KCJBKZKX",
            "COMPANY_KBE": "17",
            "BENEFICIARY_BANK": "АО Банк Demo",
            "PAYMENT_CODE": "710",
            "CLIENT_NAME": "ТОО Client Example",
            "CLIENT_IIN": "987654321098",
            "CLIENT_ADDRESS": "г. Астана, пр. Туран, 20",
            "EXECUTOR_NAME": "Иван Иванов",
            "POSITION": "Директор",
            "VAT": "Без НДС",
            "ITEMS_TOTAL_LINE": "1",
            "TOTAL_SUM": "50 000",
            "TOTAL_SUM_IN_WORDS": "Пятьдесят тысяч тенге 00 тиын",
            "items": [
                {
                    "number": 1,
