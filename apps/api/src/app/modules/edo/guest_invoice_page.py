...
async def submit_guest_invoice(
    ...
    template_data = {
        ...
        "COMPANY_IIC": profile.company_iic or "",
        "COMPANY_BIC": profile.company_bic or "",
        "COMPANY_KBE": profile.company_kbe or "",
        "BENEFICIARY_BANK": profile.beneficiary_bank or "",
        "PAYMENT_CODE": profile.payment_code or "",
        "CLIENT_NAME": profile.company_name or "",
        "CLIENT_IIN": profile.company_iin or "",
        "CLIENT_ADDRESS": profile.supplier_address or "",
